...
<div class="text-center mt-5">
    <h1 class="font-weight-bold"> Merkury </h1>
    <a href = "/" style="font-size:19px;" class="text-dark">[Edit]</a>
</div>
<div class="row container ">
    <div class="col-1"></div>
    <div class="col-7 ml-5">
        <h4 class="font-weight-bold mt-5">Efek samping merkury :</h4>
        <ul class="mt-3" style="font-size: 18px">
            <li>Menyebabkan kanker</li>
            <li>Dapat merusak mental</li>
            <li>Menyebabkan Berkurangnya Fungsi Otak</li>
            <li>Dapat Memperlambat Pertumbuhan Janin</li>
        </ul>
    </div>
</div>
