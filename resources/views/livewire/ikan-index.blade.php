    ...
    <div class="row">
        ...
        <div class="col-sm-2" style="background-color: #dcdada; border-radius: 25px; padding: 30px; font-size:14px">
            ...
            <div class="py-3">
                ...
                <form>
                    <div class="form-check mt-1 custom-control custom-checkbox">
                        <input class="form-check-input custom-control-input" checked type="checkbox" value="sepalopoda" id="defaultCheck4" wire:model='habitat'>
                        <label class="form-check-label custom-control-label" for="defaultCheck4">
                          Air Laut
                        </label>
                    </div>
                    <div class="form-check mt-1 custom-control custom-checkbox">
                        <input class="form-check-input custom-control-input" type="checkbox" value="pelagis" id="defaultCheck5" wire:model='habitat'>
                        <label class="form-check-label custom-control-label" for="defaultCheck5">
                          Air Tawar
                    </div>
                    <div class="form-check mt-1 custom-control custom-checkbox">
                        <input class="form-check-input custom-control-input" type="checkbox" value="demersal" id="defaultCheck6" wire:model='habitat'>
