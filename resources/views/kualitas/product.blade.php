        ...
        <div class="col-sm-11" style="margin-left:25px">
            <div class="achievement section-padding mt-3">
                <div class="owl-carousel owl-carousels achievement-carousel">
                    ...
                    <a href="{{route('detailproduk', ['id' => $s->ikan_id])}}">
            ...
            <div class="col-sm-11" style="margin-left:25px">
                <div class="achievement section-padding mt-3">
                    <div class="owl-carousel owl-carousels achievement-carousel">
                        ...
                        <a href="{{route('detailproduk', ['id' => $d->ikan_id])}}">
                            <div class="achievement-item bayangan"  >
                ...
                <div class="col-sm-11" style="margin-left:25px">
                    <div class="achievement section-padding mt-3">
                        <div class="owl-carousel owl-carousels achievement-carousel">
                            ...
                            <a href="{{route('detailproduk', ['id' => $p->ikan_id])}}">
                                <div class="achievement-item bayangan" >
                    ...
                    <div class="col-sm-11" style="margin-left:25px">
                        <div class="achievement section-padding mt-3">
                            <div class="owl-carousel owl-carousels achievement-carousel">
                                ...
                                <a href="{{route('detailproduk', ['id' => $under->ikan_id])}}">
                                    <div class="achievement-item bayangan">
                        ...
                        <div class="col-sm-11" style="margin-left:25px">
                            <div class="achievement section-padding mt-3">
                                <div class="owl-carousel owl-carousels achievement-carousel">
                                    ...
                                    <a href="{{route('detailproduk', ['id' => $upper->ikan_id])}}">
                                        <div class="achievement-item bayangan">
