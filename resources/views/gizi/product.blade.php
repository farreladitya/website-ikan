    ...
    <div class="row">
        ...
        <div class="achievement section-padding mt-3">
              <div class="owl-carousel owl-carousels achievement-carousel">
                ...
                <a href="{{route('detailproduk', ['idikan' => $s->ikan_id])}}">
    ...
    <div class="row">
        ...
        <div class="achievement section-padding mt-3">
              <div class="owl-carousel owl-carousels achievement-carousel">
                ...
                <a href="{{route('detailproduk', ['idikan' => $d->ikan_id])}}">
                    <div class="achievement-item bayangan"  >
    ...
    <div class="row">
        ...
        <div class="achievement section-padding mt-3">
              <div class="owl-carousel owl-carousels achievement-carousel">
                ...
                <a href="{{route('detailproduk', ['idikan' => $p->ikan_id])}}">
                    <div class="achievement-item bayangan" >
    ...
    <div class="row">
        ...
        <div class="achievement section-padding mt-3">
              <div class="owl-carousel owl-carousels achievement-carousel">
                ...
                <a href="{{route('detailproduk', ['idikan' => $under->ikan_id])}}">
                    <div class="achievement-item bayangan">
    ...
    <div class="row">
        ...
        <div class="achievement section-padding mt-3">
              <div class="owl-carousel owl-carousels achievement-carousel">
                ...
                <a href="{{route('detailproduk', ['idikan' => $upper->ikan_id])}}">
                    <div class="achievement-item bayangan">
